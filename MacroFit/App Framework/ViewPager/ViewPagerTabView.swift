...
class ViewPagerTabView: UIView {
     ...
     */
    func setup(tab:ViewPagerTab, options:ViewPagerOptions , condition:SetupCondition,_ index:Int) {
        
        switch options.tabType! {
            
        case ViewPagerTabType.basic:
            setupBasicTab(condition: condition, options: options, tab: tab, index)
     ...
     */
    fileprivate func setupBasicTab(condition:SetupCondition, options:ViewPagerOptions, tab:ViewPagerTab,_ index: Int) {
        
        switch condition {
            
        case .fitAllTabs:
            
            buildTitleLabel(withOptions: options, text: tab.title,index)
     ...
     */
    fileprivate func setupImageTab(condition:SetupCondition, withText:Bool, options:ViewPagerOptions, tab:ViewPagerTab,_ index: Int = 0) {
    ...
    fileprivate func buildTitleLabel(withOptions options:ViewPagerOptions, text:String,_ index: Int) {
        ...
        if index == 0{
            ...
            titleLabel?.font = options.tabViewTextFontDeselected
        }
    ...
    func removeHighlight(options:ViewPagerOptions) {
        ...
        self.titleLabel?.font = options.tabViewTextFontDeselected
    }
